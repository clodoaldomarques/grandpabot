...
public class SigajusBot extends TelegramLongPollingBot {
	...
	public void onUpdateReceived(Update update) {
		...
		if (cmd == null) {
			...
			if (cmd.equals("/start")) {
				sendMessage.setText("Bem vindo ao serviço de mensagens do TJRN. Para poder receber notificações do SIGAJUS, clique no botão ENVIAR NÚMERO DO TELEFONE para que possamos identificá-lo.");
	...
	public String getBotToken() {
		return "1286645858:AAHaCZ7guXaxdSvJ1w9VxJr_neoVWwQRVBY";
	}
}
